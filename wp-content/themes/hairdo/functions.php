...
***************************************/
	...
	function canon_register_widget_areas() {
...
***************************************/
	...
	function canon_check_upload_page() {
		global $pagenow;
	...
	function canon_replace_thickbox_text($translated_text, $text, $domain) {
...
***************************************/
	...
	function canon_hide_theme_settings_from_non_admins(){
...
***************************************/
	...
	function canon_filter_wp_title( $title, $sep ) {
		if ( is_feed() ) {
			return $title;
		}
