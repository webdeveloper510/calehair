                                        ...
                                        <?php
                                             ...
                                             if (!empty( $prev_post )): ?>
                                                  ...
                                                  <div class="half prev">
                                                       ...
                                                       <a href="<?php echo get_permalink( $prev_post->ID ); ?>"><h4><?php echo esc_attr($prev_post->post_title); ?></h4></a>
                                                  </div>
                                        ...
                                        <?php
                                             ...
                                             if (!empty( $next_post )): ?>
                                                  ...
                                                  <div class="half next last">
                                                       ...
                                                       <a href="<?php echo get_permalink( $next_post->ID ); ?>"><h4><?php echo esc_attr($next_post->post_title); ?></h4></a>
                                                  </div>
