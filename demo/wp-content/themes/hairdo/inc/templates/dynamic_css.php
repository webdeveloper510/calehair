...
.pre-header-container, .pre-header-container ul, .pre-header-container .nav ul, .outter-wrapper.search-header-container {
	background-color: #25262a;
   	<?php if (!empty($canon_options_appearance['color_preheader_bg'])) echo "background-color: ".$canon_options_appearance['color_preheader_bg'].";"; ?>
}
...
.outter-wrapper.header-container, .header-container .nav ul, .ui-autocomplete li, .price h3, ol.graphs > li div.grey-btn, .btn.grey-btn, .price-cell.feature  {
	background-color: #17181b;
   	<?php if (!empty($canon_options_appearance['color_header_bg'])) echo "background-color: ".$canon_options_appearance['color_header_bg'].";"; ?>
}
...
.post-header-container, .post-header-container .nav ul{
	background-color: #25262a;
   	<?php if (!empty($canon_options_appearance['color_postheader_bg'])) echo "background-color: ".$canon_options_appearance['color_postheader_bg'].";"; ?>
}
...
022. PRE HEADER TERTIARY MENU BACKGROUND _________________________________________________ */
 ...
 .pre-header-container ul ul.sub-menu ul.sub-menu, .pre-header-container ul li:hover ul ul:before{
	background-color: #17181b;
   	<?php if (!empty($canon_options_appearance['color_third_prenav'])) echo "background-color: ".$canon_options_appearance['color_third_prenav'].";"; ?>
}
...
.header-container .nav li:hover ul ul, .header-container .nav li:hover ul ul:before, .tp-bullets.simplebullets.round .bullet{
	background-color: #25262a;
   	<?php if (!empty($canon_options_appearance['color_third_nav'])) echo "background-color: ".$canon_options_appearance['color_third_nav'].";"; ?>
}
...
.sidr {
	background-color: #25262a;
   	<?php if (!empty($canon_options_appearance['color_sidr_bg'])) echo "background-color: ".$canon_options_appearance['color_sidr_bg'].";"; ?>
}
...

{
	background-color: #ea3d7e;
   	<?php if (!empty($canon_options_appearance['color_btn_1_bg'])) echo "background-color: ".$canon_options_appearance['color_btn_1_bg'].";"; ?>
}
...

{
	background-color: #aa2154;
   	<?php if (!empty($canon_options_appearance['color_btn_1_hover_bg'])) echo "background-color: ".$canon_options_appearance['color_btn_1_hover_bg'].";"; ?>
}
...

{
	background-color: #ffbbe0;
   	<?php if (!empty($canon_options_appearance['color_btn_2_bg'])) echo "background-color: ".$canon_options_appearance['color_btn_2_bg'].";"; ?>
}
...
{
	background-color: #aa2154;
   	<?php if (!empty($canon_options_appearance['color_btn_2_hover_bg'])) echo "background-color: ".$canon_options_appearance['color_btn_2_hover_bg'].";"; ?>
}
...
.bbp-pagination-links a.next.page-numbers, .bbp-pagination-links a.prev.page-numbers
{
	background-color: #484b57;
   	<?php if (!empty($canon_options_appearance['color_btn_3_bg'])) echo "background-color: ".$canon_options_appearance['color_btn_3_bg'].";"; ?>
}
...
{
	background-color: #aa2154;
   	<?php if (!empty($canon_options_appearance['color_btn_3_hover_bg'])) echo "background-color: ".$canon_options_appearance['color_btn_3_hover_bg'].";"; ?>
}
...
.tablepress .sorting_desc{
	background-color: #efefef;
	<?php if (!empty($canon_options_appearance['color_feat_block_1'])) echo "background-color: ".$canon_options_appearance['color_feat_block_1'].";"; ?>
}	
...
.feat-block-2, .divider{
	background-color: #efefef;
	<?php if (!empty($canon_options_appearance['color_feat_block_2'])) echo "background-color: ".$canon_options_appearance['color_feat_block_2'].";"; ?>
}
...

{
	background-color: #f2f2f2;
   	<?php if (!empty($canon_options_appearance['color_lite_block'])) echo "background-color: ".$canon_options_appearance['color_lite_block'].";"; ?>
}
...
#buddypress .item-list-tabs ul li, #buddypress .standard-form textarea, #buddypress .standard-form input[type="text"], #buddypress .standard-form input[type="text"], #buddypress .standard-form input[type="color"], #buddypress .standard-form input[type="date"], #buddypress .standard-form input[type="datetime"], #buddypress .standard-form input[type="datetime-local"], #buddypress .standard-form input[type="email"], #buddypress .standard-form input[type="month"], #buddypress .standard-form input[type="number"], #buddypress .standard-form input[type="range"], #buddypress .standard-form input[type="search"], #buddypress .standard-form input[type="tel"], #buddypress .standard-form input[type="time"], #buddypress .standard-form input[type="url"], #buddypress .standard-form input[type="week"], #buddypress .standard-form select, #buddypress .standard-form input[type="password"], #buddypress .dir-search input[type="search"], #buddypress .dir-search input[type="text"], #buddypress form#whats-new-form textarea, #buddypress div.activity-comments form textarea, #buddypress div.item-list-tabs ul li.selected a span, #buddypress div.item-list-tabs ul li.current a span
{
	background-color: #f6f6f6;
   	<?php if (!empty($canon_options_appearance['color_form_fields_bg'])) echo "background-color: ".$canon_options_appearance['color_form_fields_bg'].";"; ?>
	color: #666666;
...
.widget-footer, .widget-footer table {
	background-color: #1e1e22;
   	<?php if (!empty($canon_options_appearance['color_footer_block'])) echo "background-color: ".$canon_options_appearance['color_footer_block'].";"; ?>
}
...
.widget-footer a.btn, .widget-footer .btn{
	...
	<?php if (!empty($canon_options_appearance['color_footer_button'])) echo "background-color: ".$canon_options_appearance['color_footer_button'].";"; ?>
}
...
.widget-footer input[type=text],  .widget-footer input[type=email], .widget-footer input[type=password], .widget-footer input[type=tel], .widget-footer textarea{
	background-color: #25262a;
   	<?php if (!empty($canon_options_appearance['color_footer_form_fields_bg'])) echo "background-color: ".$canon_options_appearance['color_footer_form_fields_bg'].";"; ?>
	color: #cacdcf;
...
.widget-footer input[type=text]:focus,  .widget-footer input[type=email]:focus, .widget-footer input[type=password]:focus, .widget-footer ul.tab-nav li, .widget-footer input[type=tel]:focus, .widget-footer textarea:focus,  .widget-footer .tab-content-block h3.v_nav, .pb_posts_graph {
	background-color: #393a41;
   	<?php if (!empty($canon_options_appearance['color_footer_alt_block'])) echo "background-color: ".$canon_options_appearance['color_footer_alt_block'].";"; ?>
}
...
div.post-footer, .widget-footer ul.tab-nav li.active, .widget-footer .tab-content-block, .widget-footer table th, .widget-footer table tr:nth-child(2n+1), .widget-footer .tab-content-block h3.v_nav.v_active, .base-wrapper{
	background-color: #25262a;
   	<?php if (!empty($canon_options_appearance['color_footer_base'])) echo "background-color: ".$canon_options_appearance['color_footer_base'].";"; ?>
}
